angular
    ...
    .controller('dashboardCtrl', [
        ...
        // large chart
            ...
            $scope.byMonthh = function (month) {
                console.log("I have been clicked");
                console.log(month);
                console.log("2017-0"+month+"-01");
                console.log();
                $scope.sale_chart_data=[
                    {date: "2017-0"+month+"-01", value: 3},
                    {date: "2017-0"+month+"-02", value: 2},
                    {date: "2017-0"+month+"-03", value: 5}];
                for (var i = 0; i < $scope.sale_chart_data.length; i++) {

                    $scope.sale_chart_data[i] = {date : new Date( $scope.sale_chart_data[i].date),
                        value :$scope.sale_chart_data[i].value};
                }
            ...
            $scope.sale_chart_data=[
                {date: "2016-08-01", value: 3},
                {date: "2016-09-01", value: 2},{date: "2016-10-01", value: 3},
                {date: "2016-11-01", value: 2},{date: "2016-12-01", value: 5},
...
*/
                console.log(sale_chart_data[0].date);
                $scope.sale_chart_data[i] = {date :new Date( $scope.sale_chart_data[i].date), value : $scope.sale_chart_data[i].value};
            }
    ...
    .controller('userMapsCtrl', [
        ...
        function($rootScope,$scope, $timeout,utils) {
            ...
            $scope.map_center = ['35.651588','10.330043'];
            $scope.map_zoom = '7';
            ...
            // marker icon
            $scope.marker_icon = {
                url: utils.isHighDensity() ? 'assets/img/markers/note5marker.png' : 'assets/img/markers/note5marker.png',
            ...
            $scope.gmap_users = [
                {
                    name: "AGENCE EL GHAZELA",
                    company: "Angle De Avenue Fethi Aouheir, Rue De Palestine",
                    avatar: "assets/img/ATW.PNG",
                    lat: "36.450985",
                    lon: "10.187221"
                },
                {
                    name: "AGENCE RIADH EL ANDALOUS",
                    company: "Résidence Omrane 10 – GP 8 Cité El Ghazela",
                    avatar: "assets/img/ATW.PNG",
                    lat: "36.662784",
                    lon: "10.088344"
                },
                {
                    name: "AGENCE CITE EL KHADRA",
                    company: " 10 Av. Charles Nicole, Menzah 1",
                    avatar: "assets/img/ATW.PNG",
                    lat: "36.900362",
                    lon: "9.571986"
                },
                {
                    name: "AGENCE LES JASMINS",
                    company: " Avenue H.Bourguiba – NOUVELLE ARIANA",
                    avatar: "assets/img/ATW.PNG",
                    lat: "36.495158",
                    lon: "9.923549"
                },{
                    name: "AGENCE MENZAH 1",
                    company: "10 Av. Charles Nicole, Menzah 1",
                    avatar: "assets/img/ATW.PNG",
                    lat: "36.706835",
                    lon: "9.539027"
